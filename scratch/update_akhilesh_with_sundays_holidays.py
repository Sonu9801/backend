...
try:
    ...
    print(f"Updating August 2026 attendance for {worker.name} with Sundays and Holidays...")
    ...
    if payroll:
        ...
        print(f"- Days Present (Worked): {payroll.days_present}")
        print(f"- Sunday Work/Count: {payroll.sunday_work}")
        print(f"- Holiday Work/Count: {payroll.holiday_work}")
        print(f"- Leave Days / Holidays: {payroll.leave_days}")
        print(f"- Net Working Days (Paid Days): {payroll.net_working_days}")

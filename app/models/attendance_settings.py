...
class AttendanceSettings(Base):
    ...
    latitude = Column(Float, default=28.475117)
    longitude = Column(Float, default=77.297224)
    geofence_radius = Column(Integer, default=10000)
    ...
    ot_start_time = Column(String, default='18:00:00')
